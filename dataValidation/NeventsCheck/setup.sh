...
svn export svn+ssh://rfletche@svn.cern.ch/reps/atlasoff/PhysicsAnalysis/HiggsPhys/Run2/HGamma/xAOD/HGamTools/branches/HGamTools-00-00-51-branch/data/input/PhotonAllSys.txt ./InputFiles/PhotonAllSys_h015.txt
