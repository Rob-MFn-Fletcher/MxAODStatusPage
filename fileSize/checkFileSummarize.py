...
for inputDataset in fileNames:
    ...
    tempLine = info[1]
    Nevents  = float( tempLine[60:71].replace(" ","") )
    ...
    #catNames =  ["EventFormat","EventInfo", "HGamEventInfo", "HGamPhotons", "HGamElectrons",  "HGamMuons", "HGamAntiKt4EMTopoJets" ,"HGamMET_Reference_AntiKt4EMTopo", "Total of these categories","Total of file"]
    catNames =  ["EventFormat","EventInfo", "HGamEventInfo","HGamTruthEventInfo", "HGamPhotons","HGamTruthPhotons", "HGamElectrons","HGamTruthElectrons",  "HGamMuons","HGamTruthMuons", "HGamAntiKt4EMTopoJets","HGamAntiKt4TruthJets" ,"HGamMET_Reference_AntiKt4EMTopo","HGamMET_Truth","HGamTruthHiggsBosons", "Total of these categories","Total of file"]
